...
String host = "192.168.1.4"; //alamat IP Server
String token = "1855926026:AAHXzyJua6pcOSGVxX7JEL-zRS78GatJhdo";
int id = 1216699815;
int kec_motor = 0;
...
//variabel
long duration, distance, ket_asli;
